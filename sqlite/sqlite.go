...
func NewTest(pkgURL, pkgName, drvName, connStr string) *drivercaps.DriverTest {
	t := &drivercaps.DriverTest{
		...
		Columns: []*drivercaps.ColumnDefn{
			...
			&drivercaps.ColumnDefn{DDL: "VARYING CHARACTER"},
			&drivercaps.ColumnDefn{DDL: "VARYING CHARACTER (8)"},
			&drivercaps.ColumnDefn{DDL: "NCHAR"},
			&drivercaps.ColumnDefn{DDL: "NCHAR (55)"},
			&drivercaps.ColumnDefn{DDL: "NATIVE CHARACTER"},
			&drivercaps.ColumnDefn{DDL: "NATIVE CHARACTER (8)"},
